...
<form method="POST" onsubmit="return validateForm()" action="crudprof.php">
<label for="">Nome:</label>
    <input type="text" name="nome" id="texto" oninput="handleInput(event)" required value="<?php echo $nome ?>">
    <label for="">Idade:</label>
    <input type="text" name="idade" id="idade" required value="<?php echo $idade ?>">
    ...
    <input type="text" name="estatus" id="" required value="<?php echo $estatus ?>">
