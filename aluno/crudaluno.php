...
<?php
    ##permite acesso as variaveis dentro do arquivo conexao
    ...
    if (isset($_GET['cadastrar'])) {
        ...
        if ($sqlcombanco->execute()) {
            echo "<div class='message'>
                    <strong>OK!</strong> O aluno $nome foi incluído com sucesso!!!
    ...
    if (isset($_POST['update'])) {
        ...
        if ($stmt->execute()) {
            echo "<div class='message'>
                    <strong>OK!</strong> O aluno $nome foi alterado com sucesso!!!
                    <button><a href='http://localhost/atividade_17_07/index.php'>Voltar</a></button>
                  </div>";
        }
    }
    ...
    if (isset($_GET['excluir'])) {
        ...
        if ($stmt->execute()) {
            echo "<div class='message'>
                    <strong>OK!</strong> O aluno com ID $id foi excluído!!!
                    <button><a href='listaalunos.php'>Voltar</a></button>
                  </div>";
        }
    }
?>
