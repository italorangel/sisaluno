                    ...
                    <?php foreach($retorno->fetchall() as $value) { ?>
                        ...
                        <td class="alter">
                               <form method="POST" action="altprof.php">
                                        ...
                                        <button name="alterar" style=' border-radius: 10px;width:80px;margin-right:5px;margin-left:5px; box-shadow: 0px 4px 4px 0px rgb(25, 25, 25);;height:30px;cursor:pointer;
